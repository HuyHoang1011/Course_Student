  ...
  useEffect(() => {
    const fetchAnalytics = async () => {
      try {
        ...
        const quizzesRes = await axios.get('http://localhost:5000/api/quizzes/instructor', {
        ...
        for (const quiz of quizzes) {
          const submissionsRes = await axios.get(`http://localhost:5000/api/quizzes/${quiz._id}/submissions`, {
            headers: { Authorization: `Bearer ${token}` }
          });
